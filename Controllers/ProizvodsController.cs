...
namespace Projekt_Kristian.Controllers
{
    public class ProizvodsController : Controller
    {
        ...
        public ProizvodsController(Projekt_KristianContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Naziv_Proizvoda,Cijena,Link_Slika")] Proizvod proizvod)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Naziv_Proizvoda,Cijena,Link_Slika")] Proizvod proizvod)
        {
            if (id != proizvod.Id)
            {
                return NotFound();
